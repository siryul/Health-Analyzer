...
class HomeFragment : Fragment() {
    ...
    private fun initFunc() {
        ...
        funcList.add(Func("睡眠质量", R.drawable.ic_psychological_sleep_quality_64))
        funcList.add(Func("血氧量", R.drawable.ic_blood_oxygen_64))
        funcList.add(Func("身高", R.drawable.ic_high_64))
        funcList.add(Func("体脂率", R.drawable.ic_bodyfat_64))
    }
}